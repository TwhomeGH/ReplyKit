...
old1 = '''    private let processingTimeout: TimeInterval = 5.0
    private var processingGeneration: UInt64 = 0'''

new1 = '''    private let processingTimeout: TimeInterval = 5.0
    private var processingGeneration: UInt64 = 0
...
old2 = '''        guard !isProcessing else { return }
        isProcessing = true
...
new2 = '''        videoQueue.async { [weak self] in
            guard let self else { return }
