    ...
    var body: some View {
        ...
        VStack {
            ...
            VStack {
                ...
                Text("App音量: \(String(format: "%.2f%%", volumeToPercentage(appVolume))) 原始:\(String(format: "%.2f%", appVolume * 100))")
                    .font(.headline)
            ...
            VStack {
                // 顯示用：直接顯示真實音量百分比
                Text("Mic音量: \(String(format: "%.2f%%", volumeToPercentage(micVolume))) 原始:\(String(format: "%.2f%", micVolume * 100))")
                    .font(.headline)
